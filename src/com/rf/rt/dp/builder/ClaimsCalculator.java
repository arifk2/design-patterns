...
class ClaimCalculatorDriver {
	public static void main(String[] args) {

		ClaimsCalculator claimsCalculator1 = new ClaimsCalculator.ClaimBuilder("claimId", "customerId", new Date(),
		...
		ClaimsCalculator claimsCalculator2 = new ClaimsCalculator.ClaimBuilder("CLAIM12", "CUST343", new Date(),
				9009.878).build();
		System.out.println(claimsCalculator1);
